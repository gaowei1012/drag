...
import { LoginOutlined, MenuFoldOutlined, MessageOutlined, MenuUnfoldOutlined, AlignCenterOutlined } from '@ant-design/icons'

const { Header } = Layout

const AppHeader = (props) => {
    let { menuClick, avatar, menuToggle, loginOut, apply_for_token } = props
    const menu = (
        <Menu>
